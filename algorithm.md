...
# 1️⃣ Что вообще хотят алгоритмы STL

Все алгоритмы STL устроены одинаково:

algo(input_begin, input_end, output_iterator);

Они:

- читают из входных итераторов
    
- пишут через **output-iterator**
...
Это принцип: **алгоритмы не зависят от контейнеров**.
